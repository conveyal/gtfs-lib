...
public abstract class GTFS {
     ...
     */
    public static ValidationResult validate (String feedId, DataSource dataSource, BiFunction<Feed, SQLErrorStorage, FeedValidator>... customValidators) {
        Feed feed = new Feed(dataSource, feedId);
        ValidationResult result = feed.validate(customValidators);
        return result;
    }
