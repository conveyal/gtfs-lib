...
public enum NewGTFSErrorType {
    ...
    FLEX_FORBIDDEN_DEPARTURE_TIME(Priority.HIGH, "It is forbidden to define a departure time when either start pickup drop off window or end pickup dropoff window are defined."),
    ...
    FLEX_FORBIDDEN_STOP_AREA_AREA_ID(Priority.HIGH, "It is forbidden to define a stop area area id with the same value as a stop id or location id."),
    FLEX_FORBIDDEN_LOCATION_ID(Priority.HIGH, "It is forbidden to define a location id with the same value as a stop id."),
    FLEX_FORBIDDEN_MEAN_DURATION_FACTOR(Priority.HIGH, "It is forbidden to define a mean duration factor when a stop id does not refer to a stop area or location."),
    FLEX_FORBIDDEN_MEAN_DURATION_OFFSET(Priority.HIGH, "It is forbidden to define a mean duration offset when a stop id does not refer to a stop area or location."),
    FLEX_FORBIDDEN_SAFE_DURATION_FACTOR(Priority.HIGH, "It is forbidden to define a safe duration factor when a stop id does not refer to a stop area or location."),
    FLEX_FORBIDDEN_SAFE_DURATION_OFFSET(Priority.HIGH, "It is forbidden to define a safe duration offset when a stop id does not refer to a stop area or location."),
    FLEX_FORBIDDEN_START_PICKUP_DROPOFF_WINDOW(Priority.HIGH, "It is forbidden to define a start pickup drop off window when either an arrive time or departure time are defined."),
    FLEX_FORBIDDEN_END_PICKUP_DROPOFF_WINDOW(Priority.HIGH, "It is forbidden to define a end pickup drop off window when either an arrive time or departure time are defined."),
    ...
    FLEX_REQUIRED_END_PICKUP_DROPOFF_WINDOW(Priority.HIGH, "End pickup drop off window is required if a stop id refers to a stop area or location."),
    ...
    FLEX_REQUIRED_START_PICKUP_DROPOFF_WINDOW(Priority.HIGH, "Start pickup drop off window is required if stop id refers to a stop area or location."),
