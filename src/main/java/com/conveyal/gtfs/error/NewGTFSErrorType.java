...
public enum NewGTFSErrorType {
    ...
    FLEX_FORBIDDEN_ARRIVAL_TIME(Priority.HIGH, "It is forbidden to define an arrival_time when either start_pickup_dropoff_window or end_pickup_dropoff_window are defined."),
    FLEX_FORBIDDEN_DEPARTURE_TIME(Priority.HIGH, "It is forbidden to define a departure_time when either start_pickup_dropoff_window or end_pickup_dropoff_window are defined."),
    FLEX_FORBIDDEN_DROP_OFF_TYPE(Priority.HIGH, "It is forbidden to define a drop off type of 0 (Regularly scheduled pickup) when a stop_id refers to a location group or location."),
    FLEX_FORBIDDEN_LOCATION_GROUP_ID(Priority.HIGH, "It is forbidden to define a location_group_id with the same value as a stop_id or location_id."),
    FLEX_FORBIDDEN_LOCATION_ID(Priority.HIGH, "It is forbidden to define a location_id with the same value as a stop_id."),
    FLEX_FORBIDDEN_MEAN_DURATION_FACTOR(Priority.HIGH, "It is forbidden to define a mean duration factor when a stop_id does not refer to a location group or location."),
    FLEX_FORBIDDEN_MEAN_DURATION_OFFSET(Priority.HIGH, "It is forbidden to define a mean duration offset when a stop_id does not refer to a location group or location."),
    FLEX_FORBIDDEN_SAFE_DURATION_FACTOR(Priority.HIGH, "It is forbidden to define a safe duration factor when a stop_id does not refer to a location group or location."),
    FLEX_FORBIDDEN_SAFE_DURATION_OFFSET(Priority.HIGH, "It is forbidden to define a safe duration offset when a stop_id does not refer to a location group or location."),
    FLEX_FORBIDDEN_START_PICKUP_DROPOFF_WINDOW(Priority.HIGH, "It is forbidden to define a start_pickup_dropoff_window when either an arrive_time or departure_time are defined."),
    FLEX_FORBIDDEN_END_PICKUP_DROPOFF_WINDOW(Priority.HIGH, "It is forbidden to define a end_pickup_dropoff_window when either an arrive_time or departure_time are defined."),
    FLEX_FORBIDDEN_PICKUP_TYPE(Priority.HIGH, "It is forbidden to define a pickup type of 0 (Regularly scheduled pickup) when a stop_id refers to a location group or location."),
    FLEX_FORBIDDEN_PICKUP_TYPE_FOR_LOCATION(Priority.HIGH, "It is forbidden to define a pickup type of 3 (Must coordinate with driver to arrange pickup) when a stop_id refers to a location that is not a single 'LineString'."),
    FLEX_FORBIDDEN_PICKUP_TYPE_FOR_LOCATION_GROUP(Priority.HIGH, "It is forbidden to define a pickup type of 3 (Must coordinate with driver to arrange pickup) when a stop_id refers to a location group."),
    FLEX_FORBIDDEN_PRIOR_NOTICE_DURATION_MIN(Priority.HIGH, "It is forbidden to define a prior_notice_duration_min for all but booking_type 1 (Up to same-day booking with advance notice)."),
    FLEX_FORBIDDEN_PRIOR_NOTICE_DURATION_MAX(Priority.HIGH, "It is forbidden to define a prior_notice_duration_max for booking_type 0 (Real time booking) & 2 (Up to prior day(s) booking)."),
    FLEX_FORBIDDEN_PRIOR_NOTICE_LAST_DAY(Priority.HIGH, "It is forbidden to define a prior_notice_last_day for booking_type 2 (Up to prior day(s) booking)."),
    FLEX_FORBIDDEN_PRIOR_NOTICE_SERVICE_ID(Priority.HIGH, "It is forbidden to define a prior_notice_service_id if prior_notice_start_day is not defined."),
    FLEX_FORBIDDEN_PRIOR_NOTICE_START_DAY(Priority.HIGH, "It is forbidden to define a prior_notice_start_day for booking_type 0 (Real time booking)."),
    FLEX_FORBIDDEN_PRIOR_NOTICE_START_DAY_2(Priority.HIGH, "It is forbidden to define a prior_notice_start_day for booking_type 1 (Up to same-day booking with advance notice) and if prior_notice_duration_max is defined."),
    FLEX_FORBIDDEN_PRIOR_START_TIME(Priority.HIGH, "It is forbidden to define a prior_notice_start_time if prior_notice_start_day is not defined."),
    FLEX_REQUIRED_END_PICKUP_DROPOFF_WINDOW(Priority.HIGH, "end_pickup_dropoff_window is required if stop_id refers to a location group or location."),
    FLEX_REQUIRED_PRIOR_NOTICE_DURATION_MIN(Priority.HIGH, "prior_notice_last_day is required for booking_type 2 (Up to prior day(s) booking)."),
    FLEX_REQUIRED_PRIOR_NOTICE_LAST_DAY(Priority.HIGH, "prior_notice_last_day is required if stop_id refers to a location group or location."),
    ...
    FLEX_REQUIRED_START_PICKUP_DROPOFF_WINDOW(Priority.HIGH, "prior_notice_duration_min is required for booking_type 1 (Up to same-day booking with advance notice)."),
    FLEX_MISSING_FARE_RULE(Priority.HIGH, "A location zone_id must reference a fare rule. One of contains_id, destination_id or origin_id."),
