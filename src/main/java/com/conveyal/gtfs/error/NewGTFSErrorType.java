...
public enum NewGTFSErrorType {
    ...
    FLEX_FORBIDDEN_PRIOR_NOTICE_DURATION_MAX(Priority.HIGH, "It is forbidden to define a prior notice duration max for booking_type 0 (Real time booking) & 2 (Up to prior day(s) booking)."),
    FLEX_FORBIDDEN_PRIOR_NOTICE_LAST_DAY(Priority.HIGH, "It is forbidden to define a prior notice last day for booking_type 2 (Up to prior day(s) booking)."),
    ...
    FLEX_FORBIDDEN_PRIOR_NOTICE_START_DAY(Priority.HIGH, "It is forbidden to define a prior notice start day for booking_type 1 (Up to same-day booking with advance notice) and if prior notice duration max is defined."),
    ...
    FLEX_REQUIRED_PRIOR_NOTICE_DURATION_MIN(Priority.HIGH, "Prior notice last day is required for booking type 2 (Up to prior day(s) booking)."),
