 ...
 */
public class GTFSTestMTC {
    private final ByteArrayOutputStream outContent = new ByteArrayOutputStream();
    private static final String JDBC_URL = "jdbc:postgresql://localhost";
    private static final Logger LOG = LoggerFactory.getLogger(GTFSTestMTC.class);
    ...
    /**
     * Tests that a GTFS feed with long field values generates corresponding validation errors.
     */
    @Test
     ...
     * TODO: Refactor-consolidate with the same method in GTFSTest.java.
     */
    ...
    private boolean runIntegrationTestOnZipFile(
        ...
        try (Connection connection = dataSource.getConnection()) {
            ...
            ValidationResult validationResult = GTFS.validate(loadResult.uniqueIdentifier, dataSource, MTCValidator.class);
