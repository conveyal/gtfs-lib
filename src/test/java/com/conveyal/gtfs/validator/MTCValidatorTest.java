...
public class MTCValidatorTest {
    @Test
    public void validateFieldLength() {
    ...
    @Test
    public void validateFieldLength_usingObject() throws MalformedURLException {
        MTCValidator validator = new MTCValidator(null, null);
    ...
    public void validateCalendarDays() {
        ...
        assertThat(validator.validateCalendarDays(calendar), is(false));

        calendar.tuesday = 1;
        assertThat(validator.validateCalendarDays(calendar), is(true));
    }
}
